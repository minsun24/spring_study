...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명.
        *   i18n  소프트웨어의 국제화(Internationalization)에서 첫 글자인 I와 마지막 글자인 n 사이에
        *   알파벳 갯수가 18)란?
        ...
        *   8. 문자열 정렬 방법
        *
        *   문화, 유행, 행정, 법 고려하는 건 Localization (맞춤형)
        * */
...
/*
* Request Headers에 Accept-Language 필드를 통해 받는 측의 언어를 확인 가능
* */