...
public class LoggingAspect {
     ...
     *   <포인트컷 표현식>
         ...
         -
         ex)
            execution(public Integer com.ohgiraffers.
     *
     * */
...
//    @Before("execution(* com.ohgiraffers.section01.aop.*Service.*(..))")
    ...
    *   타겟 메소드를 언제 실행할지, 아니면 아예 실행을 하지 않을지의 여부도 제어한다. (필터와 유사한 개념)
    *   하지만 타겟 메소드를 실행하는 proceed() 메소드를 잊는 경우가 자주 발생하기 때문에 사용 시 주의해야 하며,
    ...
    * */
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object result = joinPoint.proceed();    // 타겟 메소드 동작 부분
